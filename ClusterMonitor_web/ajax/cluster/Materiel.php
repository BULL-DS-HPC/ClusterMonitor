	...
	<div class="row">
		<div id="breadcrumb" class="col-xs-10">
			...
			<ol class="breadcrumb pull-left">
				...
				<li><a href="#"><?php print $lang_global['materiel']; ?></a></li>
			</ol>	
	...
	<div>
		...
		<!--div id="dashboard-header" class="row">
			<div class="col-xs-12 col-sm-7">
				<h3><?php print $lang_global['materiel']; ?></h3>
			</div>
...
<script>
	$(document).ready(function() {	
		$('#nodeshows').bootstrapTable(); // init via javascript
		$('#swshows').bootstrapTable(); // init via javascript
	});
</script>
