	...
	<div class="row">
		<div id="breadcrumb" class="col-xs-10">
			...
			<ol class="breadcrumb pull-left">
				...
				<li><a href="#"><?php print $lang_global['quota']; ?></a></li>
			</ol>
	...
	<div>
		...
		<!--div id="dashboard-header" class="row">
			<div class="col-xs-12 col-sm-7">
				<h3><?php print $lang_global['quota']; ?></h3>
			</div>
...
<script>
	...
	<?php
		global $mysqli;
		$listfs="SELECT distinct(id_Filesystems) from Collect_Quota where id_Clusters = '$clustername'";
		$fs= $mysqli->query($listfs) or die ('Erreur '.$listfs.' '.$mysqli->error);

		while ($fstabexp = $fs->fetch_array()) 
		{
			echo '$("#quotashows'.$fstabexp[0].'").bootstrapTable(); // init via javascript
			';
		}
	?>
	});
