	...
	<div class="row">
		<div id="breadcrumb" class="col-xs-10">
			...
			<ol class="breadcrumb pull-left">
				...
				<li><a href="#"><?php print $lang_global['filesystem']; ?></a></li>
			</ol>
	...
	<div>
		...
		<!--div id="dashboard-header" class="row">
			<div class="col-xs-12 col-sm-7">
				<h3><?php print $lang_global['filesystem']; ?></h3>
			</div>
			<div class="hidden-xs col-sm-5">
				<h5 style="text-align:right" class="maj"> <?php statecollect($clustername);?></h5>
			</div>		
