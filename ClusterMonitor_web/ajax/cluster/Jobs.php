	...
	<div class="row">
		<div id="breadcrumb" class="col-xs-10">
			...
			<ol class="breadcrumb pull-left">
				...
				<li><a href="#"><?php print $lang_global['jobs']; ?></a></li>
			</ol>		
...
<script>
	$(document).ready(function() {	
		$('#jobsshows').bootstrapTable(); // init via javascript
	});

	// Function d'affichage de la partie caché du tableau jobs

	function detailFormatter(index, row) {
		return '<div class=col-md-4> \
					Partition : <b>'+row.Partition+'</b> \
				</div> \
				<div class=col-md-4> \
					QOS : <b>'+row.Qos+'</b> \
				</div> \
				...
				<div class=col-md-4> \
					StartTime : <b>'+row.StartTime+'</b> \
				</div> \
				<div class=col-md-4> \
					EndTime : <b>'+row.EndTime+'</b> \
				</div> \
				<div class=col-md-12> \
					Nodelist ou Reason : <b>'+row.Nodelist+'</b> \
				</div> \
			';
	}
</script>
